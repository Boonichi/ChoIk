...
public class ChooseRestaurant extends AppCompatActivity implements RestaurantListAdapter.RestaurantListClickListener {
   ...
   protected void onCreate(Bundle savedInstanceState) {
    ...
    public void onItemClick(RestaurantModel restaurantModel) {
        Intent intent = new Intent(ChooseRestaurant.this, RestaurantMenuActivity.class);
