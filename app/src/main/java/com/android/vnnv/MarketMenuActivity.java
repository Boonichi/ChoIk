...
import com.android.vnnv.adapters.MenuListAdapter;
...
public class MarketMenuActivity extends AppCompatActivity implements MenuListAdapter.MenuListClickListener {
        ...
        buttonCheckout.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                if(itemsInCartList != null && itemsInCartList.size() <= 0) {
                    Toast.makeText(MarketMenuActivity.this, "Please add some items in cart.", Toast.LENGTH_SHORT).show();
                    return;
                }
                marketModel.setMenus(itemsInCartList);
                Intent i = new Intent(MarketMenuActivity.this, PlaceYourOrderActivity.class);
